...
#from urlib.request import urlopen #pip install urlopen 'and' pip install urllib3
...
def sendEmail(to,content):
    ...
    server.login('email@gmail.com','ur_password')
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'time' in query: #tell us time when asked
            ...
            wb.get(edgepath).open_new_tab(search) #only open websites with '.com' at end.
        ...
        '''elif 'news' in query:
            try:
                jsonObj = urlopen('http://newsapi.org/v2/everything?q=bitcoin&from=2020-12-23&sortBy=publishedAt&apiKey=8889ada2c4b342e1a4b4d0660ac5c8d5') #this part is to be set private
